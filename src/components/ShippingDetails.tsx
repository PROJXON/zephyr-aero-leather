...
import type { ShippingDetailsProps } from "../../types/types";

export default function ShippingDetails({ details, errors, states }: ShippingDetailsProps) {
  ...
  return (
    <div className="w-full lg:max-w-xl">
      ...
      <div className="grid grid-cols-6 gap-1">
        ...
        />
        <ShippingFormInput
          name="address2" placeholder="Address (line 2, optional)" value={address.line2 || ""} span={3} error={errors.address2 || ""}
        />
