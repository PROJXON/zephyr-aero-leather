...
export default function AddToCartButton({ productId, className = "" }: AddToCartButtonProps) {
  ...
  return (
    <>
      ...
      {showFeedback && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 bg-neutral-dark text-white px-4 py-2 rounded-lg shadow-lg z-50 lg:hidden animate-fade-in">
